<?php
/**
 * توليد شجرة القائمة الجانبية — مطابقة بالكامل لفهرس كتاب الاونكس 2024
 * كل شاشة موجودة في الفهرس موجودة هنا برابط صحيح
 */
...
function render_menu_item(array $item, string $active, int $depth): string {
    ...
    if ($hasChildren) {
        ...
        if (!empty($item['icon'])) $html .= render_icon($item['icon'], 'h-4 w-4 shrink-0');
        ...
        $html .= '</button><ul class="sidebar-submenu">';
...
function render_icon(string $name, string $classes = 'h-4 w-4'): string {
    $icons = [
        ...
        'cart' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17"/></svg>',
        'book' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253"/></svg>',
        ...
        'building' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5"/></svg>',
        'wallet' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 003 12"/></svg>',
        'landmark' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11m4-11v11m4-11v11m4-11v11"/></svg>',
        'package' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/></svg>',
        'tag' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>',
        'receipt' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l6-6m-5.5.5h.01M19 21l-7-3-7 3V5a2 2 0 012-2h10a2 2 0 012 2v16z"/></svg>',
        'swap' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7l-4 4 4 4M4 11h12m4-4l4 4-4 4M20 13H8"/></svg>',
        'clipboard' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>',
        ...
        'activity' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2z"/></svg>',
        'chart' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>',
        'layers' => '<svg class="' . $classes . '" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2"/></svg>',
...
/**
 * هيكل القائمة الجانبية — مطابق 100% لفهرس كتاب الاونكس 2024
 */
function get_menu_sections(): array {
    return [
        ...
        // ====== المدخلات (صفحات 41-75 من الكتاب) ======
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'children' => [
                        ['id' => 'inputs-inventory-main-groups', 'label' => 'بيانات المجموعة الرئيسية', 'url_path' => 'setup/inventory-main-groups.php'],
                        ...
                        ['id' => 'inputs-item-attachments', 'label' => 'ملحقات الأصناف', 'url_path' => 'inputs/item-attachments.php'],
                        ['id' => 'inputs-composite-items', 'label' => 'الأصناف المركبة', 'url_path' => 'inputs/composite-items.php'],
                        ...
                        ['id' => 'inputs-inventory-account-link', 'label' => 'ربط حساب المخزون بالأستاذ', 'url_path' => 'inputs/inventory-account-link.php'],
                    ],
                ],
                [
                    'label' => 'مدخلات أنظمة الموردين', 'icon' => 'truck',
                    'children' => [
                        ['id' => 'inputs-supplier-groups', 'label' => 'مجموعة الموردين', 'url_path' => 'setup/supplier-groups.php'],
                ...
                [
                    ...
                    'children' => [
                        ['id' => 'inputs-customer-groups', 'label' => 'مجموعة العملاء', 'url_path' => 'setup/customer-groups.php'],
        ...
        // ====== العمليات (صفحات 76-140 من الكتاب) ======
        [
            ...
            'items' => [
                [
                    ...
                    'children' => [
                        ...
                        ['id' => 'ops-payment-requests', 'label' => 'طلبات سندات الصرف', 'url_path' => 'operations/payment-requests.php'],
                        ['id' => 'ops-receipt-vouchers', 'label' => 'سندات القبض', 'url_path' => 'operations/receipt-vouchers.php'],
                        ['id' => 'ops-cheque-maturity', 'label' => 'استحقاق الشيكات يدويًا', 'url_path' => 'operations/cheque-maturity.php'],
                        ...
                        ['id' => 'ops-currency-exchange', 'label' => 'صرف عملة', 'url_path' => 'operations/currency-exchange.php'],
                ...
                [
                    ...
                    'children' => [
                        ...
                        ['id' => 'ops-transfer-receipts', 'label' => 'استلام تحويل مخزني', 'url_path' => 'operations/transfer-receipts.php'],
                ...
                [
                    'label' => 'عمليات إدارة المشتريات', 'icon' => 'truck',
                    'children' => [
                        ['id' => 'ops-purchase-invoices', 'label' => 'فاتورة المشتريات المحلية', 'url_path' => 'operations/purchase-invoices.php'],
                        ['id' => 'ops-purchase-expenses', 'label' => 'مصاريف فواتير المشتريات', 'url_path' => 'operations/purchase-expenses.php'],
                        ['id' => 'ops-purchase-returns', 'label' => 'فاتورة مردود المشتريات', 'url_path' => 'operations/purchase-returns.php'],
                        ['id' => 'ops-purchase-foreign', 'label' => 'فاتورة المشتريات الخارجية', 'url_path' => 'operations/purchase-foreign.php'],
                        ['id' => 'ops-purchase-reports', 'label' => 'تقارير المشتريات', 'url_path' => 'operations/purchase-reports.php'],
                    ],
                ],
                [
                    'label' => 'عمليات إدارة المبيعات', 'icon' => 'cart',
                    'children' => [
        ...
        // ====== إدارة النظام (صفحات 141+) ======
        [
            'id' => 'system', 'label' => 'إدارة النظام', 'icon' => 'key',
            'items' => [
                ['id' => 'system-users', 'label' => 'بيانات المستخدمين', 'icon' => 'users', 'url_path' => 'system/users.php'],
                ['id' => 'system-permissions', 'label' => 'صلاحيات الشاشة', 'icon' => 'lock', 'url_path' => 'system/screen-permissions.php'],
