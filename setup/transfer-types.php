...
render_crud_page([
    'table' => 'transfer_types', 'title' => 'أنواع التحويل', 'description' => 'أنواع التحويل المخزني (تحويل، استلام).',
    'listUrl' => 'setup/transfer-types.php', 'addUrl' => 'transfer-type-form.php', 'editUrl' => 'transfer-type-form.php',
