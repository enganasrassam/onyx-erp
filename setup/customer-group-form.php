...
render_crud_form([
    'table' => 'customer_groups', 'listUrl' => 'setup/customer-groups.php',
    ...
    'fields' => [
        ...
        ['name' => 'parent_id', 'label' => 'المجموعة الأعلى', 'type' => 'select', 'options' => ['' => '— بدون —'] + array_column(db_fetch_all("SELECT id, CONCAT(code, ' — ', name_ar) as name FROM customer_groups ORDER BY code"), 'name', 'id')],
